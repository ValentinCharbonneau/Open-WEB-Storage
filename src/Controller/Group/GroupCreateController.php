...
#[Route('/%base_ged_version%/dir', name: 'group_create', methods: ['POST'])]
class GroupCreateController extends AbstractController
{
    public function __invoke(
        ...
        try {
            ...
            return new JsonResponse($serializer->normalize($GEDService->createGroup($groupDTO), 'json', $outputContext->toArray()));
